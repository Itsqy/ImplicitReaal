...
import com.syatria.implicitintentreal.databinding.ActivityAudioManagerBinding
...
class AudioManagerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnRing.setOnClickListener {
            ...
            Toast.makeText(this, "Ini adaalah mode biasa ", Toast.LENGTH_SHORT).show()
        }
        binding.btnGetar.setOnClickListener {
            audioManager.ringerMode = AudioManager.RINGER_MODE_VIBRATE
            Toast.makeText(this, "Ini adaalah mode getar ", Toast.LENGTH_SHORT).show()
        }
        binding.btnSilent.setOnClickListener {
            ...
            Toast.makeText(this, "Ini adaalah mode silent ", Toast.LENGTH_SHORT).show()
        }
    }
}